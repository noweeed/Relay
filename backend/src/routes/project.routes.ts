...
projectRouter.post("/", validateRequest({ body: createProjectSchema }), asyncHandler(projectController.createProject));
...
projectRouter.post(
  "/:projectId/kanban/columns",
  validateRequest({ params: kanbanProjectParamsSchema, body: createKanbanColumnSchema }),
  requireProjectMembership,
...
projectRouter.put(
  ...
  validateRequest({ params: kanbanProjectParamsSchema, body: reorderKanbanColumnsSchema }),
  requireProjectMembership,
  requireProjectRole("owner", "admin"),
...
projectRouter.patch(
  ...
  validateRequest({ params: kanbanColumnParamsSchema, body: updateKanbanColumnSchema }),
  requireProjectMembership,
  requireProjectRole("owner", "admin"),
...
projectRouter.delete(
  "/:projectId/kanban/columns/:columnId",
  validateRequest({ params: kanbanColumnParamsSchema, query: deleteKanbanColumnQuerySchema }),
  requireProjectMembership,
  requireProjectRole("owner", "admin"),
...
projectRouter.get(
  "/:projectId/meetings",
  validateRequest({ params: projectParamsSchema, query: listMeetingsQuerySchema }),
  requireProjectMembership,
...
projectRouter.patch(
  ...
  validateRequest({ params: meetingParamsSchema, body: updateMeetingStatusSchema }),
  requireProjectMembership,
  requireProjectRole("owner", "admin"),
...
projectRouter.post(
  ...
  validateRequest({ params: projectParamsSchema, body: inviteProjectMemberSchema }),
  requireProjectMembership,
  requireProjectRole("owner", "admin"),
